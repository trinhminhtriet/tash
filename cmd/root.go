...
const (
	appName      = "tash"
	shortAppDesc = "tash is a task runner for local and remote hosts"
	longAppDesc  = `tash is a task runner for local and remote hosts.

You define servers and tasks in a tash.yaml config file and then run the tasks on the servers.
`
)
